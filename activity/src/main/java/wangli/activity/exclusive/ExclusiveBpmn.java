package wangli.activity.exclusive;
 ...
 * @Description:
 */
public class ExclusiveBpmn {

    /**
     * 创建日志答应对象信息
     */
    private static Log log = LogFactory.getLog(ExclusiveBpmn.class);
    /**
     * 创建工作流引擎实例
     */
    ...
    public void deplyment(){
        ...
        InputStream inputStreambpmn = this.getClass().getClassLoader().getResourceAsStream("diagrams/exclusiveGateway/exclusiveGateway.bpmn");
        InputStream inputStreampng = this.getClass().getClassLoader().getResourceAsStream("diagrams/exclusiveGateway/exclusiveGateway.png");
